...
const methodKey=row=>{const m=String(row.payment_method||"");if(m==="QR ngân hàng"||m==="Chuyển khoản")return "bank";if(m==="Tiền mặt")return "cash";if(m==="Miễn phí")return "free";return "other"};
const methodLabel=k=>k==="bank"?"Chuyển khoản & QR":k==="cash"?"Tiền mặt":k==="free"?"Miễn phí":"Khác";
const methodClass=k=>k==="bank"?"payment-bank":k==="cash"?"payment-cash":k==="free"?"payment-free":"payment-other";
const methodIcon=k=>k==="bank"?"🏦":k==="cash"?"💵":k==="free"?"🎁":"•";
